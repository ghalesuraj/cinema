	    ...
	    public function MB_Ticket_view_columns_for_ticket( $column, $post_id ) {
	    	switch ( $column ) {
	    		case $this->prefix.'ticket_id':
                    ...
                    $ticket_edit_url 	= get_edit_post_link( $ticket_number );
                ...
                case $this->prefix.'movie':
                    ...
                    $movie_edit_url = get_edit_post_link( $movie_id );
                ...
                case $this->prefix.'date':
                    ...
                    if ( $date ) {
                    	...
                    	if ( $showtime_id ) {
                    		$showtime_edit_url = get_edit_post_link( $showtime_id );
                ...
                case $this->prefix.'seat':
                    ...
                    if ( $room_id ) {
                    	$room_edit_url = get_edit_post_link( $room_id );
