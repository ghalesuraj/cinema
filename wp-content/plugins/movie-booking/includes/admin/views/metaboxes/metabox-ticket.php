...
$ticket_url = get_edit_post_link( $ticket_id );
...
$movie_url      = get_edit_post_link( $movie_id );
...
if ( $showtime_id ) {
    $showtime_url   = get_edit_post_link( $showtime_id );
...
if ( $room_id ) {
    $room_url   = get_edit_post_link( $room_id );
